...
final class DecodeFormatManager {
  ...
  public static Set<BarcodeFormat> ALL_FORMATS = EnumSet.noneOf(BarcodeFormat.class);
  ...
  static {
    ...
    INDUSTRIAL_FORMATS =
        EnumSet.of(BarcodeFormat.CODE_39, BarcodeFormat.CODE_93, BarcodeFormat.CODE_128,
    ...
    ALL_FORMATS.addAll(AZTEC_FORMATS);
    ALL_FORMATS.addAll(PDF417_FORMATS);
  }
